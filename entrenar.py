...
# Cargar datasets
df_fake = pd.read_csv("onlyfakes500.csv")  # Noticias falsas
df_true = pd.read_csv("dataset_traducido_true.csv")  # Noticias reales
...
X = df["Texto"]  # Solo el texto de la noticia
y = df["Etiqueta"]  # Etiqueta fake=0, real=1
